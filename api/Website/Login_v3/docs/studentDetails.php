      ...
      <?php
          ...
          while($row  = mysqli_fetch_array($result)){ ?>
              <tr id="<?php echo $row['RollNo']; ?>">
                ...
                <td data-target="EmailID"><?php echo $row['EmailID']; ?></td>
  ...
  $(document).ready(function(){
    ...
    //  append values in input fields
      $(document).on('click','a[data-role=update]',function(){
            ...
            var Name  = $('#'+RollNo).children('td[data-target=Name]').text();
            var EmailID  = $('#'+RollNo).children('td[data-target=EmailID]').text();
            var PhoneNo  = $('#'+RollNo).children('td[data-target=PhoneNo]').text();
       ...
       $('#save').click(function(){
         ...
         var BranchID =  $('#BranchID').val();
          ...
          $.ajax({
              url      : 'connection.php',
              method   : 'post', 
              data     : {RollNo : RollNo , BranchID: BranchID , Name : Name , EmailID: EmailID, PhoneNo: PhoneNo},
